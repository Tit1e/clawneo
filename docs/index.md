...
- Focused on Discord-first usage instead of a broad multi-channel platform
- Built for practical local work with files, search, and shell tools
- Keeps durable user context through structured storage and a human-editable profile
